    ...
    <div className="bg-white dark:bg-darker transition-all duration-150 ease-in-out">
      ...
      >
        <Head>
          ...
          <meta
            name="description"
            content="The portfolio of Tonny Batya, Software Developer, Software Engineer, Blockchain Developer"
          />
          ...
          <main className={`flex-col items-center justify-center flex h-screen`} id="home" ref={homeRef}>
            ...
            <div className="container relative flex flex-col items-center justify-center flex-grow px-0 mx-auto md:px-20 lg:px-24 section">
              <div className="grid justify-items-center">
                <h1 className="m-12 text-2xl md:text-6xl dark:text-white text-dark">
                  TONNY BATYA
                </h1>
                <h2 className="m-8 text-xl md:text-3xl dark:text-light text-mid">
                  <ReactTypingEffect
                    typingDelay={200}
                    speed={30}
                    eraseSpeed={30}
